...
There is one patient whose predicted value is less than 0, but this patient is a clear outlier in the data. For the majority of the data except for the tails, the residuals are dispersed evenly on average across predicted values.
